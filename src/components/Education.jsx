...
const Education = () => {
  return (
    <div className="w-3/5 m-2 flex flex-col justify-center backdrop-brightness-80 h-[80vh] p-4 rounded-4xl">
      <h2 className="text-4xl font-bold orbitron text-white hover:text-amber-300 text-center">Education</h2>
      <div className="mt-6 space-y-6">
        {educationData.map((edu, index) => (
          <motion.div
            key={index}
            className="group max-h-[20vh] relative bg-gray-300 p-4 rounded-xl cursor-pointer overflow-hidden transition-all duration-500"
