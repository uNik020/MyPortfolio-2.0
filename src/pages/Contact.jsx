...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_oyeg114", // Replace with your EmailJS Service ID
        "template_0wwu4q6", // Replace with your EmailJS Template ID
        formRef.current,
        "qbBx8aFYuFvkkLx1l" // Replace with your EmailJS Public Key
      )
      .then(
        () => {
  ...
  return (
    <section id="contact" className="w-full py-16 bg-gray-800">
      ...
      <div className="max-w-4xl lg:max-w-2xl mx-auto px-6">
        {/* Title */}
        <motion.h2
        ...
        <motion.form
          ...
          className="mt-8 space-y-6 bg-gray-800 p-6 rounded-lg shadow-lg"
        >
          <div>
